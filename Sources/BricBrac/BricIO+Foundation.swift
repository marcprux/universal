...
private func createJSONEncoder(_ outputFormatting: JSONEncoder.OutputFormatting, sortedKeys: Bool, withoutEscapingSlashes: Bool) -> JSONEncoder {
    ...
    if sortedKeys, #available(macOS 10.13, iOS 13.0, watchOS 6.0, *) {
        fmt = fmt.union(.sortedKeys)
    }

    if withoutEscapingSlashes, #available(macOS 10.15, iOS 13.0, watchOS 6.0, *) {
...
public extension JSONEncoder {
    ...
    @available(macOS 10.13, iOS 13.0, watchOS 6.0, *)
