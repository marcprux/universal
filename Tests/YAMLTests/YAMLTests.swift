...
//        XCTAssertEqual(try yaml("~"), nil)
        XCTAssertEqual(try yaml("NuLL"), .str("NuLL"))
        XCTAssertEqual(try yaml("null#"), .str("null#"))
        XCTAssertEqual(try yaml("null#string"), .str("null#string"))
//        XCTAssertEqual(try yaml("null #comment"), nil)
    ...
    func testBool() {
        ...
        XCTAssertEqual(try yaml("TRUE"), .true)
        XCTAssertEqual(try yaml("trUE"), .str("trUE"))
        XCTAssertEqual(try yaml("true#"), .str("true#"))
        XCTAssertEqual(try yaml("true#string"), .str("true#string"))
        ...
        XCTAssertEqual(try yaml("faLSE"), .str("faLSE"))
        XCTAssertEqual(try yaml("false#"), .str("false#"))
        XCTAssertEqual(try yaml("false#string"), .str("false#string"))
...
//        XCTAssertEqual(try yaml("+0").integer, 0)
    ...
    func testDouble() {
        XCTAssertEqual(try yaml(".inf"), .dbl(Double.infinity))
        ...
        XCTAssert(try yaml(".nan") != .dbl(Double.nan))
        ...
        XCTAssertEqual(try yaml("0."), .dbl(0))
...
//        XCTAssertEqual(try yaml("[ true ]"), [YAML.bol(true)])
